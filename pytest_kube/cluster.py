...
# existingcluster as base?
# other classes derive from that and fill in admin-kubeconfig or some kubeconfig?
# 
# existingcluster provides .api on access by using that kubeconfig
#
# how to use different kubeconfigs?
#   with each function. if missing use default
